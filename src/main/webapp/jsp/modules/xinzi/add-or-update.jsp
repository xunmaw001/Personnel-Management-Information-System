                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>生日</label>
                                        <input id="birthdayTime" name="birthdayTime" class="form-control"
...
<script>
    ...
    function yonghuDataBind(){
        ...
        var birthdayTimeDate = new Date();
        birthdayTimeDate.setTime(ruleForm.birthdayTime);
        $("#birthdayTime").val(birthdayTimeDate.toLocaleString());//把时间戳转换为日期带时分秒格式
