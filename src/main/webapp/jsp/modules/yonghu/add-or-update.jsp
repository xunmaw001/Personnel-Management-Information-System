                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <div class="form-group col-md-6">
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>生日</label>
                                       <input id="birthdayTime-input" name="birthdayTime" class="form-control" type="text" readonly>
                                   </div>
                                   <div class="form-group col-md-6">
                                       <label>部门</label>
                                       <select id="bumenTypesSelect" name="bumenTypes" class="form-control aaaaa">
                                       </select>
                                   </div>
                                   <div class="form-group col-md-6">
                                       <label>职位</label>
                                       <select id="zhiweiTypesSelect" name="zhiweiTypes" class="form-control aaaaa">
                                       </select>
                                   </div>
                                   <div class="form-group col-md-6">
                                       <label>性别</label>
...
<script>
    ...
    //数字检查
        ...
        function idNumberChickValue(e){
            ...
            if(!reg.test(this_val)){
                ...
                var birthday =this_val.substring(6,14);
                var year =birthday.substring(0,4);
                var month =birthday.substring(4,6);
                var day =birthday.substring(6,8);
                var d= new Date(year,month,day,00,00,00);
                var strat = new Date(1960,01,01,00,00,00);//最大生日不能为1960年
                var end = new Date();//最小生日不能是当天
                if(d.getTime()<strat.getTime() || d.getTime()>end.getTime()){
                    e.value = "";
                    alert("身份证输入不合法");
                    return false;
                }
                $("#birthdayTime-input").val(year+"-"+month+"-"+day);
            }
        }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#birthdayTime-input").val(ruleForm.birthdayTime);
